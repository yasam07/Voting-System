...
{{--Page Header--}}
    <div class=" flex justify-between border-b" >
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Location Management  / Municipality  / Update</h2>
    ...
    <div class="mt-5 shadow-lg ps-6 py-4">
        <form action="{{ route('admin.locations.municipalities.update', $municipality) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    <x-partials.dropdown 
                        ...
                        label="District"
                        :selected=" old('district')?? $municipality->district_id"
                        :options="$districts"
                    />
                    @error('district')
            ...
            <x-partials.button type="submit" variant="primary">Update Municipality</x-partials.button>
        </form>
    </div>
