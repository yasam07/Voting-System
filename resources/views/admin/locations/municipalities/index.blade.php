...
{{--Page Header--}}
    ...
    <div class="flex justify-between">
        <h1 class="font-bold text-2xl mt-6">Municipality</h1>
        <x-partials.button class="mt-6" href="{{ route('admin.locations.municipalities.create') }}" variant="primary">Create municipality</x-partials.button>
    </div>
        ...
        <table class="w-full border-collapse text-sm">
            ...
            <tbody class="border-b">
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-3 w-30 text-center">{{ $municipality->name }}</td>
                    <td class="px-4 py-3 w-30 text-center">{{ $municipality->district->name }}</td>
                    <td class="px-4 py-3 w-25 text-center">
                        <span class="px-3 py-1 rounded-full text-sm
                            {{ $municipality->status ? 'text-green-600 font-semibold' : 'text-red-600 font-semibold' }}">
