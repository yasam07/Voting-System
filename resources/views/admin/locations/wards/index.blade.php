...
{{--Page Header--}}
    <div >
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Location Management  / Wards</h2>
            <p class="text-sm text-gray-600">
                Locations information by Wards
            </p>
        </div>
    </div>
    ...
    <div class="flex justify-between">
        <h1 class="font-bold text-2xl mt-6">Wards</h1>
        <x-partials.button class="mt-6" href="{{ route('admin.locations.wards.create') }}" variant="primary">Create Ward</x-partials.button>
    </div>
        ...
        <table class="w-full border-collapse text-sm">
            <thead class="bg-gray-100 text-gray-700 border-b">
                <tr>
                    ...
                    <th class="px-4 py-3 w-30 text-center">Municipality</th>
                    <th class="px-4 py-3 w-30 text-center">Ward No.</th>
            ...
            <tbody class="border-b">
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-3 w-30 text-center">{{ $ward->municipality->name }}</td>
                    <td class="px-4 py-3 w-30 text-center">{{ $ward->ward_no }}</td>
                    <td class="px-4 py-3 w-25 text-center">
                        <span class="px-3 py-1 rounded-full text-sm
                            {{ $ward->status ? 'text-green-600 font-semibold' : 'text-red-600 font-semibold' }}">
