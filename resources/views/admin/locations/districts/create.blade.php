...
{{--Page Header--}}
    <div class=" flex justify-between border-b" >
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Location Management  / District  / Create</h2>
    ...
    <div class="mt-5 shadow-lg ps-6 py-4">
        <form action="{{ route('admin.locations.districts.store') }}" method="POST">
            ...
            <x-partials.button type="submit" variant="primary">Add District</x-partials.button>
        </form>
    </div>
