...
{{--Page Header--}}
    <div class=" flex justify-between border-b" >
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Political Party Management  / Create</h2>
    ...
    <div class="mt-5 shadow-lg ps-6 py-4">
        <form action="{{ route('admin.parties.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    <label for="name" >Political Party Name:</label><br/>
                    <input type="text" 
                        name="name" 
                        id="name" 
            ...
            <x-partials.button type="submit" variant="primary">Add Party</x-partials.button>
        </form>
    </div>
