...
{{--Page Header--}}
    <div class="border-b">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Party Management</h2>
    ...
    <div class="flex justify-between ">
        <div class="mt-6">
            <h1 class="font-bold text-2xl">Party</h1>
        </div>
        <div class="mt-6">
            <x-partials.button href="{{ route('admin.parties.create') }}" variant="primary">Create Party</x-partials.button>
        </div>
    </div>
        ...
        <table class="w-full border-collapse text-sm">
            ...
            <tbody>
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-3 w-40 text-center">{{ $party->name }}</td>
                    <td class="px-4 py-3 w-40 text-center">
                        <span class="px-3 py-1 rounded-full text-sm
                            {{ $party->status ? 'text-green-600 font-semibold' : 'text-red-700 font-semibold' }}">
