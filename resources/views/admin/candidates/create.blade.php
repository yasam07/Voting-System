...
<div class="flex justify-between">
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Candidate Management / Create</h2>
        <p class="text-sm text-gray-600">
            Create Candidates by location and posts
        </p>
    </div>
    ...
    <form action="{{ route('admin.candidates.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" value="{{ old('name') }}" placeholder="Name" class="w-full px-4 mt-2 py-2 border border-gray-300 rounded">
                ...
                <div class="flex items-center space-x-6">
                    @foreach(['male','female','other'] as $gender)
                        <label class="flex items-center space-x-2">
                            <input type="radio" name="gender" value="{{ $gender }}" {{ old('gender') == $gender ? 'checked' : '' }} class="form-radio text-blue-600">
