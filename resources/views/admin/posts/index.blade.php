...
{{--Page Header--}}
    ...
    <div class="flex justify-between ">
        ...
        <div class="mt-6">
            <x-partials.button href="{{ route('admin.posts.create') }}" variant="primary">Create Post</x-partials.button>
        </div>
    </div>
        ...
        <table class="w-full border-collapse text-sm">
            ...
            <tbody>
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-3 w-40 text-center">{{ $post->name }}</td>
                    <td class="px-4 py-3 w-40 text-center">
                        <span class="px-3 py-1 rounded-full text-sm
                            {{ $post->status ? 'text-green-600 font-semibold' : 'text-red-700 font-semibold' }}">
